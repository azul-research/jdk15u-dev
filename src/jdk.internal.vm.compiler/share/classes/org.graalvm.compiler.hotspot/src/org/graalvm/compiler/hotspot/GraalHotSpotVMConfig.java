...
public class GraalHotSpotVMConfig extends GraalHotSpotVMConfigAccess {
    ...
    public final int psrInfoDczidValue = getFieldValue("VM_Version::_psr_info.dczid_el0", Integer.class, "uint32_t", 0x10,
                    (JVMCI ? jvmciGE(JVMCI_19_3_b04) : (JDK == 14 || (JDK == 15 && JDK_UPDATE < 6))) && osArch.equals("aarch64"));

    public final int zvaLength = getFieldValue("VM_Version::_zva_length", Integer.class, "int", 0, (JDK >= 16 || (JDK == 15 && JDK_UPDATE >= 6)) && osArch.equals("aarch64"));
